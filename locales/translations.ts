...
const tr: Translations = {
  ...
  story_body2: 'Kökleri Adana\'ya uzanan şef Mehmet Ali Öztürk, nesiller boyu aktarılan ocak geleneğini çağdaş fine dining anlayışıyla harmanlıyor. Doğru malzeme, doğru ateş ve doğru an; ÂLÂ mutfağındaki her tabak bu üçlünün ürünü.',
  ...
  chef_bio1: 'Adana\'nın ateşli ocaklarında büyüyen Mehmet Ali, 7 yaşında babasının yanında mangal başında durmaya başladı. Paris\'te Le Cordon Bleu\'yu tamamladıktan ve Michelin yıldızlı mutfaklarda çalıştıktan sonra Antalya\'ya taşındı; ÂLÂ Ocakbaşı\'nı kurarak ocakbaşı kültürünü fine dining masasına taşıdı.',
  chef_bio2: '20 yılı aşkın mutfak deneyimini geleneksel Akdeniz teknikleriyle harmanlayan şef, ocakbaşı kültürünü uluslararası gastronomi sahnesine taşıdı. Her tabak, saatlerce süren hazırlığın ve tek tek seçilen malzemelerin ürünü.',
...
const en: Translations = {
  ...
  story_body2: 'Chef Mehmet Ali Öztürk, whose roots reach back to Adana\'s fiery hearths, began at his father\'s grill at the age of seven. After completing Le Cordon Bleu in Paris and working in Michelin-starred kitchens, he moved to Antalya and founded ÂLÂ Ocakbaşı.',
  ...
  chef_bio1: 'Growing up beside the fiery hearths of Adana, Mehmet Ali began standing at his father\'s grill at the age of seven. After completing Le Cordon Bleu in Paris and working in Michelin-starred restaurants, he moved to Antalya and opened ÂLÂ Ocakbaşı.',
  chef_bio2: 'With over 20 years of culinary experience grounded in traditional Mediterranean techniques, the chef brought the ocakbaşı culture to the international dining scene. Every plate is the result of careful preparation and ingredients selected one by one.',
...
const de: Translations = {
  ...
  story_body2: 'Küchenchef Mehmet Ali Öztürk, dessen Wurzeln in den feurigen Herden Adanas liegen, begann im Alter von sieben Jahren neben dem Grill seines Vaters zu stehen. Nach dem Abschluss am Le Cordon Bleu in Paris und der Arbeit in Michelin-Sterne-Küchen zog er nach Antalya und gründete ÂLÂ Ocakbaşı.',
  ...
  chef_bio1: 'Mehmet Ali wuchs neben den feurigen Herden Adanas auf und stand bereits mit sieben Jahren neben dem Grill seines Vaters. Nach dem Abschluss am Le Cordon Bleu in Paris und der Arbeit in Michelin-Sterne-Küchen zog er nach Antalya und eröffnete ÂLÂ Ocakbaşı.',
  chef_bio2: 'Mit über 20 Jahren kulinarischer Erfahrung, verankert in traditionellen mediterranen Techniken, brachte der Küchenchef die Ocakbaşı-Kultur auf die internationale Gastronomie-Bühne. Jeder Teller ist das Ergebnis stundenlanger Vorbereitung und sorgfältig ausgewählter Zutaten.',
...
const ar: Translations = {
  ...
  story_body2: 'الشيف محمد علي أوزتورك، الذي نشأ بجوار موقد أبيه في أضنة، بدأ يقف بجانب الشواية منذ السابعة من عمره. بعد تخرجه من لو كوردون بلو في باريس وعمله في مطاعم نجوم ميشلان، انتقل إلى أنطاليا وأسس ÂLÂ Ocakbaşı.',
  ...
  chef_bio1: 'نشأ محمد علي بجوار موقد أبيه في أضنة، وبدأ يقف بجانب الشواية منذ السابعة من عمره. بعد تخرجه من لو كوردون بلو في باريس وعمله في مطاعم نجوم ميشلان، استقر في أنطاليا وأسس ÂLÂ Ocakbaşı.',
  chef_bio2: 'دمج الشيف أكثر من 20 عاماً من الخبرة الطهوية مع تقنيات البحر الأبيض المتوسط التقليدية، ليُدخل ثقافة أوجاق باشي إلى عالم المطاعم الفاخرة. كل طبق هو نتاج تحضير دقيق ومكونات يُختار كل واحد منها بعناية.',
...
const ru: Translations = {
  ...
  story_body2: 'Шеф-повар Мехмет Али Озтурк, чьи корни уходят в огненные очаги Аданы, начал работать у гриля отца в возрасте семи лет. Окончив Le Cordon Bleu в Париже и поработав в ресторанах со звёздами Мишлен, он переехал в Анталью и основал ÂLÂ Ocakbaşı.',
  ...
  chef_bio1: 'Мехмет Али вырос рядом с огненными очагами Аданы и начал работать у гриля отца в семь лет. После окончания Le Cordon Bleu в Париже и работы в ресторанах со звёздами Мишлен он переехал в Анталью и открыл ÂLÂ Ocakbaşı.',
  chef_bio2: 'Объединяя более 20 лет кулинарного опыта с традиционными средиземноморскими техниками, шеф принёс культуру очагбашы в международную гастрономию. Каждое блюдо — результат тщательной подготовки и ингредиентов, отобранных по одному.',
...
const fr: Translations = {
  ...
  story_body2: 'Le chef Mehmet Ali Öztürk, dont les racines plongent dans les âtres ardents d\'Adana, a commencé à travailler au gril de son père dès l\'âge de sept ans. Après son diplôme du Cordon Bleu à Paris et ses années dans des cuisines étoilées Michelin, il s\'est installé à Antalya et a fondé ÂLÂ Ocakbaşı.',
  ...
  chef_bio1: 'Mehmet Ali a grandi auprès des foyers ardents d\'Adana et a commencé à travailler au gril de son père à l\'âge de sept ans. Après son diplôme du Cordon Bleu à Paris et ses années dans des cuisines étoilées Michelin, il s\'est installé à Antalya et a ouvert ÂLÂ Ocakbaşı.',
  chef_bio2: 'Fort de plus de 20 ans d\'expérience culinaire mêlée aux techniques méditerranéennes traditionnelles, le chef a introduit la culture de l\'ocakbaşı dans la gastronomie internationale. Chaque assiette est le fruit d\'une préparation soignée et d\'ingrédients choisis un par un.',
