  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(212,175,55,0.03) 0%, transparent 60%)',
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 md:gap-20 items-center">
          ...
          <div className="chef-image opacity-0 relative">
            <div
              className="absolute -bottom-4 -right-4 w-full h-full border border-luxury-gold/20 pointer-events-none z-10"
            ...
            >
              <p className="font-instrument italic text-luxury-cream/80 text-sm leading-relaxed">
                &ldquo;Her alev bir hikayedir, her duman bir anı.&rdquo;
              </p>
            </motion.div>
          </div>
          ...
          <div className="chef-text-block opacity-0">
            ...
            <p className="text-luxury-cream/40 text-sm tracking-[0.2em] uppercase font-inter mb-8">
              Executive Chef & Kurucu
            </p>

            <div className="w-12 h-px bg-luxury-gold/40 mb-8" />

            <div className="space-y-4 mb-12">
              <p className="text-luxury-cream/60 font-inter font-light leading-relaxed text-sm">
                Adana&apos;nın ateşli ocaklarında büyüyen Mehmet Ali, 7 yaşında babasının
                yanında mangal başında durmaya başladı. Paris&apos;te Le Cordon Bleu&apos;yu
                bitirdikten sonra Michelin yıldızlı restoranlarla çalışarak geldi
                İstanbul&apos;a — ve bir efsane yarattı.
              </p>
              <p className="text-luxury-cream/60 font-inter font-light leading-relaxed text-sm">
                20 yılı aşkın mutfak deneyimini geleneksel Akdeniz teknikleriyle
                harmanlayan şef, ocakbaşı geleneğini dünya sahnesine taşıdı.
                Her tabak; saatler süren hazırlık, özenle seçilmiş malzemeler ve
                derin bir tutkudan doğuyor.
              </p>
            </div>
            ...
            <div className="awards-list space-y-4">
              ...
              {awards.map((award) => (
                ...
                >
                  <span className="text-luxury-gold/40 font-instrument text-lg w-12 shrink-0">
                    {award.year}
                  </span>
                  <div>
                    <p className="text-luxury-cream/80 text-sm font-inter">{award.title}</p>
                    <p className="text-luxury-cream/30 text-[10px] tracking-wider uppercase font-inter mt-0.5">
                      {award.org}
                    </p>
                  </div>
                </div>
